...
!function (t, e) {
    ...
    return function (t) {
        ...
        i = [r(2)], void 0 !== (n = function (t) {
            ...
            function l(t, e, r, i, n, a, s, l, h) {
                ...
                for (var u = (h = h > 1 ? 1 : h < 0 ? 0 : h) / 2, c = [-.1252, .1252, -.3678, .3678, -.5873, .5873, -.7699, .7699, -.9041, .9041, -.9816, .9816], f = [.2491, .2491, .2335, .2335, .2032, .2032, .1601, .1601, .1069, .1069, .0472, .0472], p = 0, d = 0; d < 12; d++) {
                    var g = u * c[d] + u, v = o(g, t, r, n, s), x = o(g, e, i, a, l), y = v * v + x * x;
                    p += f[d] * I.sqrt(y)
                }
                return u * p
            }
            ...
            function c(t, r, i) {
                ...
                for (v = 0; v < h; v++)for (var y = 0; y < c; y++) {
                    var m = f[v], b = f[v + 1], _ = p[y], w = p[y + 1], k = O(b.x - m.x) < .001 ? "y" : "x",
                        B = O(w.x - _.x) < .001 ? "y" : "x", C = u(m.x, m.y, b.x, b.y, _.x, _.y, w.x, w.y);
                    if (C) {
            ...
            function g(t, e, r, i, n, a) {
                ...
                var l = 3 * e, h = 3 * (i - e) - l, u = 1 - l - h, c = 3 * r, f = 3 * (n - r) - c, p = 1 - c - f;
                return function (t, e) {
                    var r = o(t, e);
                    return ((p * r + f) * r + c) * r
                }(t, 1 / (200 * a))
            ...
            function x(r, i, n, a, s, o) {
                ...
                if (a)for (w = 0, k = ne.length; w < k; w++) {
                    var b = ne[w];
                ...
                if (l) {
                    if (h) h.initstatus = a, h.start = new Date - h.ms * a; else {
                        for (var C in l)if (l[B](C) && (et[B](C) || i.paper.customAttributes[B](C)))switch (x[C] = i.attr(C), null == x[C] && (x[C] = tt[C]), y[C] = l[C], et[C]) {
                            case W:
                                m[C] = (y[C] - x[C]) / v;
                                break;
                            case"colour":
                                x[C] = e.getRGB(x[C]);
                                var S = e.getRGB(y[C]);
                                m[C] = {r: (S.r - x[C].r) / v, g: (S.g - x[C].g) / v, b: (S.b - x[C].b) / v};
                                break;
                            case"path":
                                var A = zt(x[C], y[C]), T = A[1];
                                ...
                                break;
                            case"transform":
                                var L = i._, F = It(L[C], y[C]);
                                if (F)for (x[C] = F.from, y[C] = F.to, m[C] = [], m[C].real = !0, w = 0, k = x[C].length; w < k; w++)for (m[C][w] = [x[C][w][0]], M = 1, N = x[C][w].length; M < N; M++)m[C][w][M] = (y[C][w][M] - x[C][w][M]) / v; else {
                                    var R = i.matrix || new p, j = {
                                ...
                                break;
                            case"csv":
                                var I = z(l[C])[P](_), D = z(x[C])[P](_);
                                if ("clip-rect" == C)for (x[C] = D, m[C] = [], w = D.length; w--;)m[C][w] = (I[w] - x[C][w]) / v;
                                y[C] = I;
                                break;
                            default:
                                for (I = [][E](l[C]), D = [][E](x[C]), m[C] = [], w = i.paper.customAttributes[C].length; w--;)m[C][w] = ((I[w] || 0) - (D[w] || 0)) / v
                        }
                        var q = l.easing, O = e.easing_formulas[q];
                        if (!O)if ((O = z(q).match($)) && 5 == O.length) {
                            var V = O;
                            O = function (t) {
            ...
            var m, b, _ = /[, ]+/, w = {circle: 1, rect: 1, path: 1, ellipse: 1, text: 1, image: 1}, k = /\{(\d+)\}/g,
                B = "hasOwnProperty", C = {doc: document, win: window},
                S = {was: Object.prototype[B].call(C.win, "Raphael"), is: C.win.Raphael}, A = function () {
                    this.ca = this.customAttributes = {}
                }, T = "apply", E = "concat",
                M = "ontouchstart" in C.win || C.win.DocumentTouch && C.doc instanceof DocumentTouch, N = "", L = " ",
                z = String, P = "split",
                F = "click dblclick mousedown mousemove mouseout mouseover mouseup touchstart touchmove touchend touchcancel"[P](L),
                R = {mousedown: "touchstart", mousemove: "touchmove", mouseup: "touchend"}, j = z.prototype.toLowerCase,
                I = Math, D = I.max, q = I.min, O = I.abs, V = I.pow, Y = I.PI, W = "number", G = "array",
                ...
                U = {NaN: 1, Infinity: 1, "-Infinity": 1}, $ = /^(?:cubic-)?bezier\(([^,]+),([^,]+),([^,]+),([^\)]+)\)/,
                Z = I.round, Q = parseFloat, J = parseInt, K = z.prototype.toUpperCase, tt = e._availableAttrs = {
                    "arrow-end": "none",
                    "arrow-start": "none",
                    blur: 0,
                ...
                it = {hs: 1, rg: 1}, nt = /,?([achlmqrstvxz]),?/gi,
                ...
                ht = function (t, e) {
                    ...
                    if (!e)return t;
                    var r, i, n, a, s, o, l;
                    for (n = 0, s = (t = zt(t)).length; n < s; n++)for (a = 1, o = (l = t[n]).length; a < o; a += 2)r = e.x(l[a], l[a + 1]), i = e.y(l[a], l[a + 1]), l[a] = r, l[a + 1] = i;
                    return t
                };
            ...
            e.svg = !(e.vml = "VML" == e.type), e._Paper = A, e.fn = b = A.prototype = e.prototype, e._id = 0, e.is = function (t, e) {
                ...
                if (i = e.is(i, "finite") ? i : 10, e.is(t, G)) {
                    for (var n = t.length; n--;)if (O(t[n] - r) <= i)return t[n]
                } else {
                    var a = r % (t = +t);
                    if (a < i)return r - a;
            ...
            e.getRGB = n(function (t) {
                if (!t || (t = z(t)).indexOf("-") + 1)return {r: -1, g: -1, b: -1, hex: "none", error: 1, toString: a};
            ...
            e.findDotsAtSegment = function (t, e, r, i, n, a, s, o, l) {
                var h = 1 - l, u = V(h, 3), c = V(h, 2), f = l * l, p = f * l,
            ...
            var Bt = e.pathBBox = function (t) {
                ...
                for (var i, n = 0, a = 0, s = [], o = [], l = 0, h = (t = zt(t)).length; l < h; l++)if ("M" == (i = t[l])[0]) n = i[1], a = i[2], s.push(n), o.push(a); else {
                    var u = Lt(n, a, i[1], i[2], i[3], i[4], i[5], i[6]);
                    s = s[E](u.min.x, u.max.x), o = o[E](u.min.y, u.max.y), n = i[5], a = i[6]
                }
                var c = q[T](0, s), f = q[T](0, o), p = D[T](0, s), d = D[T](0, o), g = p - c, v = d - f,
                ...
                if (e.is(t, G) && e.is(t && t[0], G) || (t = e.parsePathString(t)), !t || !t.length)return [["M", 0, 0]];
                ...
                for (var u, c, f = 3 == t.length && "M" == t[0][0] && "R" == t[1][0].toUpperCase() && "Z" == t[2][0].toUpperCase(), p = h, d = t.length; p < d; p++) {
                    ...
                    } else if ("R" == c[0]) g = [n, a][E](c.slice(1)), i.pop(), i = i[E](s(g, f)), u = ["R"][E](c.slice(-2)); else for (var y = 0, m = c.length; y < m; y++)u[y] = c[y];
                    switch (u[0]) {
                        case"Z":
                            n = o, a = l;
                            break;
                ...
                var c, f = 120 * Y / 180, p = Y / 180 * (+a || 0), d = [], g = n(function (t, e, r) {
                    return {x: t * I.cos(r) - e * I.sin(r), y: t * I.sin(r) + e * I.cos(r)}
                });
                if (u) B = u[0], C = u[1], w = u[2], k = u[3]; else {
                    t = (c = g(t, e, -p)).x, e = c.y, l = (c = g(l, h, -p)).x, h = c.y;
                    I.cos(Y / 180 * a), I.sin(Y / 180 * a);
                    var v = (t - l) / 2, x = (e - h) / 2, y = v * v / (r * r) + x * x / (i * i);
                    y > 1 && (r *= y = I.sqrt(y), i *= y);
                    var m = r * r, b = i * i,
                        _ = (s == o ? -1 : 1) * I.sqrt(O((m * b - m * x * x - b * v * v) / (m * x * x + b * v * v))),
                        w = _ * r * x / i + (t + l) / 2, k = _ * -i * v / r + (e + h) / 2,
                        B = I.asin(((e - k) / i).toFixed(9)), C = I.asin(((h - k) / i).toFixed(9));
                ...
                S = C - B;
                var N = I.cos(B), L = I.sin(B), z = I.cos(C), F = I.sin(C), R = I.tan(S / 4), j = 4 / 3 * r * R,
                    D = 4 / 3 * i * R, q = [t, e], V = [t + j * L, e - D * N], W = [l + j * F, h - D * z], G = [l, h];
                ...
                var l, h = n - 2 * r + t - (s - 2 * n + r), u = 2 * (r - t) - 2 * (n - r), c = t - r,
                    f = (-u + I.sqrt(u * u - 4 * h * c)) / 2 / h, p = (-u - I.sqrt(u * u - 4 * h * c)) / 2 / h,
                    d = [e, o], g = [t, s];
            ...
            }, null, Ct), Pt = (e._parseDots = n(function (t) {
                ...
                for (i = 1, n = r.length - 1; i < n; i++)if (!r[i].offset) {
                    for (var o = Q(r[i - 1].offset || 0), l = 0, h = i + 1; h < n; h++)if (r[h].offset) {
                        l = r[h].offset;
                        break
                    }
                    l || (l = 100, h = n);
                ...
                var r = Bt(t), i = {
                    _: {transform: N}, getBBox: function () {
                        return r
                    }
                };
                ...
                var i = e.parseTransformString(r), n = 0, a = 0, s = 0, o = 1, l = 1, h = t._, u = new p;
                if (h.transform = i || [], i)for (var c = 0, f = i.length; c < f; c++) {
                    var d, g, v, x, y, m = i[c], b = m.length, _ = z(m[0]).toLowerCase(), w = m[0] != _,
                        k = w ? u.invert() : 0;
            ...
            e._getContainer = function (t, r, i, n) {
                ...
                t.add = function (t, e, r, i, n, a) {
                    var s, o, l, h, u = [[], [], []],
                        ...
                        f = [[t, r, n], [e, i, a], [0, 0, 1]];
                    for (t && t instanceof p && (f = [[t.a, t.c, t.e], [t.b, t.d, t.f], [0, 0, 1]]), s = 0; s < 3; s++)for (o = 0; o < 3; o++) {
                    ...
                    var n = +I.cos(t).toFixed(9), a = +I.sin(t).toFixed(9);
            ...
            for (var Dt = function () {
                ...
                return C.doc.addEventListener ? function (t, e, r, i) {
                    ...
                    if (t.addEventListener(e, n, !1), M && R[e]) {
                        var a = function (e) {
                            for (var n = Yt(e), a = e, s = 0, o = e.targetTouches && e.targetTouches.length; s < o; s++)if (e.targetTouches[s].target == t) {
                    ...
                    var n = function (t) {
                        t = t || C.win.event;
                        var e = C.doc.documentElement.scrollTop || C.doc.body.scrollTop,
                            n = C.doc.documentElement.scrollLeft || C.doc.body.scrollLeft, a = t.clientX + n,
                            s = t.clientY + e;
                ...
                for (var r, i = e.clientX, n = e.clientY, a = C.doc.documentElement.scrollTop || C.doc.body.scrollTop, s = C.doc.documentElement.scrollLeft || C.doc.body.scrollLeft, o = Gt.length; o--;) {
                    if (r = Gt[o], M && e.touches) {
                        for (var l, h = e.touches.length; h--;)if ((l = e.touches[h]).identifier == r.el._drag.id) {
            ...
            Ut.drag = function (r, i, n, a, s, o) {
                function l(l) {
                    ...
                    var h = l.clientX, u = l.clientY, c = C.doc.documentElement.scrollTop || C.doc.body.scrollTop,
                        f = C.doc.documentElement.scrollLeft || C.doc.body.scrollLeft;
                    if (this._drag.id = l.identifier, M && l.touches)for (var p, d = l.touches.length; d--;)if (p = l.touches[d], this._drag.id = p.identifier, p.identifier == this._drag.id) {
                ...
                return this._drag = {}, Zt.push({el: this, start: l}), this.mousedown(l), this
            ...
            b.getElementByPoint = function (t, e) {
                var r = this, i = r.canvas, n = C.doc.elementFromPoint(t, e);
                if (C.win.opera && "svg" == n.tagName) {
                    var a = Qt(i), s = i.createSVGRect();
                ...
                var e = {
                    ...
                    offsety: t.offsety || 0,
                    color: t.color || "#000"
                }, r = e.width / 2, i = this.paper, n = i.set(), a = this.realPath || pt[this.type](this);
            ...
            var ie = e.easing_formulas = {
                linear: function (t) {
                    ...
                    var e = .48 - t / 1.04, r = I.sqrt(.1734 + e * e), i = r - e, n = -r - e,
                ...
                ae = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || function (t) {
                    ...
                    for (var r = +new Date, i = 0; i < ne.length; i++) {
                        ...
                        if (!n.el.removed && !n.paused) {
                            var a, s, o = r - n.start, l = n.ms, h = n.easing, u = n.from, c = n.diff, f = n.to,
                                p = (n.t, n.el), d = {}, g = {};
                            if (n.initstatus ? (o = (n.initstatus * n.anim.top - n.prev) / (n.percent - n.prev) * l, n.status = n.initstatus, delete n.initstatus, n.stop && ne.splice(i--, 1)) : n.status = (n.prev + (n.percent - n.prev) * (o / l)) / n.anim.top, !(o < 0))if (o < l) {
                                var v = h(o / l);
                                for (var y in u)if (u[B](y)) {
                                    switch (et[y]) {
                                        case W:
                                            a = +u[y] + v * l * c[y];
                                            break;
                                        ...
                                        case"path":
                                            ...
                                            break;
                                        case"transform":
                                            if (c[y].real)for (a = [], m = 0, b = u[y].length; m < b; m++)for (a[m] = [u[y][m][0]], _ = 1, w = u[y][m].length; _ < w; _++)a[m][_] = u[y][m][_] + v * l * c[y][m][_]; else {
                                                var k = function (t) {
                                            ...
                                            break;
                                        case"csv":
                                            if ("clip-rect" == y)for (a = [], m = 4; m--;)a[m] = +u[y][m] + v * l * c[y][m];
                                            break;
                                        default:
                                            var C = [][E](u[y]);
            ...
            Ut.animateWith = function (t, r, i, n, a, s) {
                ...
                for (var h = 0, u = ne.length; h < u; h++)if (ne[h].anim == r && ne[h].el == t) {
                ...
                if (a)return i && (o.easing = i), n && (o.callback = n), new v({100: o}, r);
                if (n) {
                    var l = 0;
                    for (var h in t) {
                        var u = J(h);
                ...
                for (r = ne.length; a < r; a++)if ((i = ne[a]).el.id == this.id && (!t || i.anim == t)) {
                ...
                for (var r = 0; r < ne.length; r++)if (ne[r].el.id == this.id && (!e || ne[r].anim == e)) {
                    var i = ne[r];
            ...
            var le = function (t) {
                if (this.items = [], this.length = 0, this.type = "set", t)for (var e = 0, r = t.length; e < r; e++)!t[e] || t[e].constructor != Ut.constructor && t[e].constructor != le || (this[this.items.length] = this.items[this.items.length] = t[e], this.length++)
            }, he = le.prototype;
            he.push = function () {
            ...
            return he.attr = function (t, r) {
                if (t && e.is(t, G) && e.is(t[0], "object"))for (var i = 0, n = t.length; i < n; i++)this.items[i].attr(t[i]); else for (var a = 0, s = this.items.length; a < s; a++)this.items[a].attr(t, r);
                return this
            }, he.clear = function () {
                ...
                if (this.fonts[r] ? this.fonts[r].push(e) : this.fonts[r] = [e], !t.svg) {
                    ...
                    for (var n in t.glyphs)if (t.glyphs[B](n)) {
                        ...
                        if (e.glyphs[n] = {
                            ...
                            }, a.k)for (var s in a.k)a[B](s) && (e.glyphs[n].k[s] = a.k[s])
                    }
                }
                return t
                ...
                if (n = n || "normal", i = i || "normal", r = +r || {
                    ...
                    var l;
                    if (a)for (var h = 0, u = a.length; h < u && ((l = a[h]).face["font-weight"] != r || l.face["font-style"] != i && l.face["font-style"] || l.face["font-stretch"] != n); h++);
                    return l
                }
            }, b.print = function (t, r, i, n, a, s, o, l) {
                s = s || "middle", o = D(q(o || 0, 1), -1), l = D(q(l || 1, 3), 1);
                var h, u = z(i)[P](N), c = 0, f = 0, p = N;
                if (e.is(n, "string") && (n = this.getFont(n)), n) {
                    ...
                    for (var d = n.face.bbox[P](_), g = +d[0], v = d[3] - d[1], x = 0, y = +d[1] + ("baseline" == s ? v + +n.face.descent : v / 2), m = 0, b = u.length; m < b; m++) {
                        if ("\n" == u[m]) c = 0, k = 0, f = 0, x += v * l; else {
                            var w = f && n.glyphs[u[m - 1]] || {}, k = n.glyphs[u[m]];
                ...
                if (e.is(t, "array"))for (var r, i = this.set(), n = 0, a = t.length; n < a; n++)r = t[n] || {}, w[B](r.type) && i.push(this[r.type]().attr(r));
                return i
                ...
                if (S.was) C.win.Raphael = S.is; else {
        ...
        var i, n;
        !function (r) {
            var a, s, o = "hasOwnProperty", l = /[\.\/]/, h = /\s*,\s*/, u = function (t, e) {
                return t - e
            }, c = {n: {}}, f = function () {
                for (var t = 0, e = this.length; t < e; t++)if (void 0 !== this[t])return this[t]
            }, p = function () {
                for (var t = this.length; --t;)if (void 0 !== this[t])return this[t]
            }, d = Object.prototype.toString, g = String, v = Array.isArray || function (t) {
                    return t instanceof Array || "[object Array]" == d.call(t)
                };
            eve = function (t, e) {
                var r, i = s, n = Array.prototype.slice.call(arguments, 2), o = eve.listeners(t), l = 0, h = [], c = {},
                    d = [], g = a;
                ...
                for (h.sort(u); h[l] < 0;)if (r = c[h[l++]], d.push(r.apply(e, n)), s)return s = i, d;
                for (v = 0; v < x; v++)if ("zIndex" in (r = o[v]))if (r.zIndex == h[l]) {
                    if (d.push(r.apply(e, n)), s)break;
                    do {
                        if (l++, (r = c[h[l]]) && d.push(r.apply(e, n)), s)break
                    } while (r)
                } else c[r.zIndex] = r; else if (d.push(r.apply(e, n)), s)break;
                return s = i, a = g, d
            }, eve._events = c, eve.listeners = function (t) {
                var e, r, i, n, a, s, o, h, u = v(t) ? t : t.split(l), f = c, p = [f], d = [];
                for (n = 0, a = u.length; n < a; n++) {
                    for (h = [], s = 0, o = p.length; s < o; s++)for (r = [(f = p[s].n)[u[n]], f["*"]], i = 2; i--;)(e = r[i]) && (h.push(e), d = d.concat(e.f || []));
                    p = h
                }
                return d
                ...
                for (var r = v(t) ? v(t[0]) ? t : [t] : g(t).split(h), i = 0, n = r.length; i < n; i++)!function (t) {
                    for (var r, i = v(t) ? t : g(t).split(l), n = c, a = 0, s = i.length; a < s; a++)n = (n = n.n).hasOwnProperty(i[a]) && n[i[a]] || (n[i[a]] = {n: {}});
                ...
                if (t) {
                    ...
                    if (r.length > 1)for (var i = 0, n = r.length; i < n; i++)eve.off(r[i], e); else {
                        r = v(t) ? t : g(t).split(l);
                        var a, s, u, f, p, d = [c];
                        for (i = 0, n = r.length; i < n; i++)for (f = 0; f < d.length; f += u.length - 2) {
                            if (u = [f, 1], a = d[f].n, "*" != r[i]) a[r[i]] && u.push(a[r[i]]); else for (s in a)a[o](s) && u.push(a[s]);
                            d.splice.apply(d, u)
                        }
                        for (i = 0, n = d.length; i < n; i++)for (a = d[i]; a.n;) {
                            if (e) {
                                if (a.f) {
                                ...
                                for (s in a.n)if (a.n[o](s) && a.n[s].f) {
                                    var x = a.n[s].f;
                                    for (f = 0, p = x.length; f < p; f++)if (x[f] == e) {
                                        x.splice(f, 1);
                                        break
                                    }
        ...
        i = [r(1)], void 0 !== (n = function (t) {
            if (!t || t.svg) {
                ...
                var v = function (i, n) {
                    ...
                    if ("path" == i.type) {
                        ...
                        if ("open" == w ? (k += 2, B += 2, C += 2, l = 1, h = a ? 4 : 1, u = {
                            ...
                            var S = "raphael-marker-" + w, A = "raphael-marker-" + x + w + k + B + "-obj" + i.id;
                        ...
                        } else a ? (s = i._.arrows.startdx * b || 0, o = t.getTotalLength(m.path) - s) : (s = 0, o = t.getTotalLength(m.path) - (i._.arrows.enddx * b || 0)), i._.arrows[x + "Path"] && v(y, {d: t.getSubpath(m.path, s, o)}), delete i._.arrows[x + "Path"], delete i._.arrows[x + "Marker"], delete i._.arrows[x + "dx"], delete i._.arrows[x + "Type"], delete i._.arrows[x + "String"];
                    ...
                    for (var d in a)if (a[e](d)) {
                        ...
                        switch (u[d] = g, d) {
                            ...
                            case"fill-opacity":
                                if (u.gradient) {
                                    (P = t._g.doc.getElementById(l.getAttribute("fill").replace(/^url\(#|\)$/g, c))) && (F = P.getElementsByTagName("stop"), v(F[F.length - 1], {"stop-opacity": g}));
                                    break
                                }
                            default:
                    ...
                    if ("text" == i.type && (a[e]("text") || a[e]("font") || a[e]("font-size") || a[e]("x") || a[e]("y"))) {
                        ...
                        } else for (p = 0, d = (f = o.getElementsByTagName("tspan")).length; p < d; p++)p ? v(f[p], {
                            dy: 1.2 * l,
                            x: s.x
                        }) : v(f[0], {dy: 0});
                ...
                A.prototype = T, T.constructor = A, t._engine.path = function (t, e) {
                    ...
                    if (this.removed || !e)return this;
                    var r = S(this.node), i = S(e.node || e[0].node);
                    ...
                    }), 1 == r ? (l.style.cssText = h + "position:absolute;left:" + i + "px;top:" + n + "px", t._g.doc.body.appendChild(l), o = 1) : (l.style.cssText = h + "position:relative", r.firstChild ? r.insertBefore(l, r.firstChild) : r.appendChild(l)), r = new t._Paper, r.width = a, r.height = s, r.canvas = l, r.clear(), r._left = r._top = 0, o && (r.renderfix = function () {
                    }), r.renderfix(), r
        ...
        i = [r(1)], void 0 !== (n = function (t) {
            if (!t || t.vml) {
                var e = "hasOwnProperty", r = String, i = parseFloat, n = Math, a = n.round, s = n.max, o = n.min,
                    ...
                    x = "position:absolute;left:0;top:0;width:1px;height:1px;behavior:url(#default#VML)", y = 21600,
                    m = {path: 1, rect: 1, image: 1}, b = {circle: 1, ellipse: 1}, _ = function (e) {
                ...
                var B = function (t, e, i) {
                    ...
                    n.attrs = n.attrs || {};
                    var u = n.node, p = n.attrs, d = u.style,
                    ...
                    if (g && (p.path = t._getPath[n.type](n), n._.dirty = 1), l.href && (u.href = l.href), l.title && (u.title = l.title), l.target && (u.target = l.target), l.cursor && (d.cursor = l.cursor), "blur" in l && n.blur(l.blur), (l.path && "path" == n.type || g) && (u.path = _(~r(p.path).toLowerCase().indexOf("r") ? t._pathToAbsolute(p.path) : p.path), n._.dirty = 1, "image" == n.type && (n._.fillpos = [p.x, p.y], n._.fillsize = [p.width, p.height], k(n, 1, 1, 0, 0, 0))), "transform" in l && n.transform(l.transform), v) {
                        var C = +p.cx, A = +p.cy, T = +p.rx || +p.r || 0, M = +p.ry || +p.r || 0;
                    ...
                    if ("clip-rect" in l) {
                        ...
                        if (4 == N.length) {
                            ...
                            var L = u.clipRect || t._g.doc.createElement("div"), z = L.style;
                    ...
                    if ("arrow-start" in l && B(x, l["arrow-start"]), "arrow-end" in l && B(x, l["arrow-end"], 1), null != l.opacity || null != l.fill || null != l.src || null != l.stroke || null != l["stroke-width"] || null != l["stroke-opacity"] || null != l["fill-opacity"] || null != l["stroke-dasharray"] || null != l["stroke-miterlimit"] || null != l["stroke-linejoin"] || null != l["stroke-linecap"]) {
                        ...
                        u.appendChild(F);
                        var D = u.getElementsByTagName("stroke") && u.getElementsByTagName("stroke")[0], q = !1;
                    ...
                    if ("text" == x.type) {
                        ...
                        var W = x.paper.span, G = p.font && p.font.match(/\d+(?:\.\d*)?(?=px)/);
                        ...
                        for (var X = ["x", "y", "text", "font", "font-family", "font-weight", "font-style", "font-size"], U = 0, $ = X.length; U < $; U++)if (X[U] in l) {
                            x._.dirty = 1;
                            break
                        }
                ...
                A.prototype = T, T.constructor = A, T.transform = function (e) {
                    ...
                    } else h.style.filter = f, k(this, s.scalex, s.scaley, s.dx, s.dy, s.rotate); else h.style.filter = f, l.matrix = r(o), l.offset = o.offset();
                    ...
                    var i = new A(r, e), n = {fill: "none", stroke: "#000"};
                    ...
                    var o = E("shape"), l = E("path"), h = E("textpath");
                    ...
                    var u = new A(o, e), p = {fill: "#000", stroke: "none", font: t._availableAttrs.font, text: s};
